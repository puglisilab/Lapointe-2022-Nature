function varargout = crosstalkcorrect_CA(input, varargin)
...
if nargin<2
    [ctval, ctmat] = calc_crosstalk_CA(data);
    disp(ctval);
end

% Removes the NaN from crosstalk matrix

ctmat(isnan(ctmat)) = ctval;
